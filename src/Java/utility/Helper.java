...
public class Helper {	
   ...
   */
	...
	public int inputdetector(String fileName) throws Exception{
	 ...
	 */
	public String readMatrixtoList(String Filename) throws Exception{		
			
		
		String sep = ",\\s*" ; 	
		String newFile = "InputData_in_TupleFormat.txt";
		if (isExist(newFile)) {
			delete_file(newFile);
		}
